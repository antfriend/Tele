...
public class RobotClient_06 extends PApplet {
...
public void draw() 
{
  ...
  if (c.available() > 0) {
    ...
    stroke(0);
    rect(PApplet.parseInt(px), PApplet.parseInt(ps), PApplet.parseInt(px) + s_height, ps + s_height);//draw the box ***
...
public void mouseReleased()
{
  ...
  static public void main(String args[]) {
    PApplet.main(new String[] { "--bgcolor=#F0F0F0", "RobotClient_06" });
  }
}
